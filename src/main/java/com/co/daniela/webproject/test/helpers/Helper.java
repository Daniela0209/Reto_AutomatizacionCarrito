...
import static com.co.daniela.webproject.test.helpers.Dictionary.CONFIGURATION_PROPERTIES_FILE;
...
public class Helper {
    ...
    public static Customer generateCustomer(String language, String country, String emailDomain){
        ...
        customer.setPostalCode(faker.numerify("#####"));
        ...
        customer.setMessage("Sugiero que le hagan mantenimiento a la pagina, esta muy lenta");
        return customer;
    }
}
